...
var _estree = require("./plugins/estree.js");
var _index = require("./plugins/flow/index.js");
var _index2 = require("./plugins/jsx/index.js");
var _index3 = require("./plugins/typescript/index.js");
var _placeholders = require("./plugins/placeholders.js");
var _v8intrinsic = require("./plugins/v8intrinsic.js");
const PIPELINE_PROPOSALS = process.env.BABEL_8_BREAKING ? ["fsharp", "hack"] : ["minimal", "fsharp", "hack", "smart"];
const TOPIC_TOKENS = ["^^", "@@", "^", "%", "#"];
function validatePlugins(pluginsMap) {
  ...
  if (pluginsMap.has("pipelineOperator")) {
    ...
    const tupleSyntaxIsHash = process.env.BABEL_8_BREAKING ? pluginsMap.has("recordAndTuple") : pluginsMap.get("recordAndTuple")?.syntaxType === "hash";
    if (proposal === "hack") {
    ...
    } else if (!process.env.BABEL_8_BREAKING && proposal === "smart" && tupleSyntaxIsHash) {
...
const mixinPlugins = exports.mixinPlugins = {
  estree: _estree.default,
  jsx: _index2.default,
  flow: _index.default,
  typescript: _index3.default,
  v8intrinsic: _v8intrinsic.default,
  placeholders: _placeholders.default
};
const mixinPluginNames = exports.mixinPluginNames = Object.keys(mixinPlugins);
